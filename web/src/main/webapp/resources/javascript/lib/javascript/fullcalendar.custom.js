 ...
 *
 *
 * bnguyen 09/25/2014 - customized "renderSegHtml" function to look for custom event called displayTime
 * 			to allow sorting by datetime but making the display of the time as optional
 *
 */
...
$.extend(DayGrid.prototype, {
	...
	renderSegHtml: function(seg, disableResizing) {
		...
		if (!event.allDay && seg.isStart && (event.displayTime === undefined || event.displayTime === true)) {
